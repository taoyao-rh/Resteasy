...
import org.jboss.resteasy.plugins.server.netty.cdi2.SeCdiNettyJaxrsServer;
import org.jboss.resteasy.plugins.server.netty.cdi2.SeCdiRequestDispatcher;
...
public class SeCdiNettyTest {
    ...
    public void init() {
        ...
        SeCdiNettyJaxrsServer netty = new SeCdiNettyJaxrsServer(container);
        ResteasyDeployment rd = new ResteasyDeployment();
        rd.setActualResourceClasses(cdiExtension.getResources());
        rd.setInjectorFactory(new CdiInjectorFactory(container));
